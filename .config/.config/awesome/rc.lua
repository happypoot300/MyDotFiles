...
editor = "gvim"
editor_cmd = terminal .. " -e " .. editor .. " \"/home/happypoot300/.config/awesome/rc.lua\""
...
-- Right Click Menu Sizes
beautiful.menu_width = 150
beautiful.menu_height = 25

-- Window bg and focus color
beautiful.menu_bg_normal = "#372d38"
beautiful.menu_bg_focus = "#f1e9e6"

beautiful.menu_fg_focus = "#372d38"
...
globalkeys = gears.table.join(
    ...
    awful.spawn.with_shell("~/.config/rofi/launchers/type-3/launcher.sh") end,
